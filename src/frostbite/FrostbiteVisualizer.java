...
public class FrostbiteVisualizer {
	...
	private final static Color enemyColor = new Color(255,0,0);
	static int glob = 0;
	...
	public static Visualizer getVisualizer(FrostbiteDomain fd) {
		...
		v.addObjectClassPainter(FrostbiteDomain.ENEMYCLASS, new EnemyPainter(fd));
		return v;
	}
	public static class EnemyPainter implements ObjectPainter {
		...
		public EnemyPainter(FrostbiteDomain fd) {
			this.fd = fd;
		}
		...
		public void paintObject(Graphics2D g2, State s, ObjectInstance ob,
			...
			int size = ob.getIntValForAttribute(FrostbiteDomain.SIZEATTENEMY);
